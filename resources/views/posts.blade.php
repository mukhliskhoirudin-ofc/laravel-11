                ...
                <form>
                    ...
                    <div class="items-center mx-auto mb-3 space-y-4 max-w-screen-sm sm:flex sm:space-y-0">
                        <div class="relative w-full">
                            <label for="search" class="hidden mb-2 text-sm font-medium text-gray-900">Cari</label>
                            <div class="flex absolute inset-y-0 left-0 items-center pl-3 pointer-events-none">
                                <svg class="w-5 h-5 text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none"
                                    viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M15 17l5 5-5-5zm0 0a7 7 0 10-10-10 7 7 0 0010 10z" />
                                </svg>
                            </div>
                            <input
            ...
            <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                ...
                @empty
                    <div class="flex flex-wrap items-center justify-center text-center gap-2">
                        ...
                        <a href="/posts/" class="font-medium text-primary-600 hover:underline">
                            <b>Back to Post</b>
                        </a>
                    </div>
                @endforelse
